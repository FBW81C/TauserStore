...
if not exist %appdir%\Minecraft.exe echo 1) Download Minecraft Launcher
...
cls
echo Checking ...
if not exist %appdir%\Minecraft.exe goto downloadmclauncher
goto launch
...
:confirmation2
cls
echo Do you want to delete Minecraft.exe ? (y/n)
